...
output_directory = "/your/archive"  # Directory where the archived FLAC files will be saved
...
output_file = os.path.join(output_directory, f"{radioname}_archive_{current_timestamp}.flac")

# Start recording the livestream to a FLAC file
ffmpeg_command = ["ffmpeg", "-i", livestream_url, "-c:a", "flac", "-t", str(archiving_duration), output_file]
